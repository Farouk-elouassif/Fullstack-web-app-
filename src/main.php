<main class="flex-1 m-4 flex flex-col items-center justify-center">
  ...
  <div id="partenaire" class="py-8 flex justify-center flex-col m-12">
    <h3 class=" mb-4 self-center font-bold text-2xl text-blue-900"><i class="fa-solid fa-handshake text-yellow-500 mr-2"></i>Partenaires</h3>
    <marquee id="logos" class="mb-2 flex flex-row justify-end items-center space-x-8 w-full overflow-hidden" direction="right">
      <img src="../imgs/Expleo.png" alt="" width="150" class="inline">
      <img src="../imgs/Docapost.png" alt="" width="150" class="inline">
      <img src="../imgs/FABLAB.png" alt="" width="150" class="inline">
      <img src="../imgs/inra.png" alt="" width="150" class="inline">
      <img src="../imgs/inrh.png" alt="" width="150" class="inline">
      <img src="../imgs/chambre-d-commerce-espagnole.png" alt="" width="150" class="inline">
      <img src="../imgs/UAEE.png" alt="" width="150" class="inline">
      <img src="../imgs/region_TTH.png" alt="" width="150" class="inline">
      <img src="../imgs/onssa.png" alt="" width="150" class="inline">
      <img src="../imgs/renault_nissan.png" alt="" width="150" class="inline">
      <img src="../imgs/SEBN.png" alt="" width="130" class="inline">
    </marquee>
  </div>
